        ...
        messages = [
            SystemMessage(
                content=(
                    ...
                    "verification. "
                    "Use response_composer when sufficient verified material "
                    "exists, verification failed and a cautious response is "
                    "required, or the evidence retry limit has been reached. "
